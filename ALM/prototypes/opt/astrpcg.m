function [xj]=astrpcg(x0,fgH,tol,Del0,a,b,prec,precini)
%
%
...
%
% function [xn]=astrpcg(x0,fgH,tol,Del0,a,b,prec,precini)
%
% Affine-Scaling Trust-Region Newton method with Steihaug-PCG solver
% for TR-subproblems
%
...
while (norm(gh)>tol*max(1,nmgh0))
 ...
 Qt=Dh*H*Dh+Ds;
 gt=dh.*g;
 st=solvetraspcg(Qt,gt,Del,min(0.5,norm(gh)),a-xj,b-xj,dh,prec,precini);
