function [xj]=astrdlg(x0,fgH,tol,Del0,a,b,pausefreq)
%
%
...
%
% function [xn]=astrdlg(x0,fgH,tol,Del0,a,b,pausefreq)
%
% Affine-Scaling Trust-Region Newton method with Dogleg-type solver
% for TR-subproblems
%
...
while (norm(gh)>tol*max(1,nmgh0))
 ...
 Qt=Dh*H*Dh+Ds;
 gt=dh.*g;
 st=solvetrasdl(Qt,gt,Del,a-xj,b-xj,dh);
